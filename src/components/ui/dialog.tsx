...
function shouldAutoSubmit(e: React.KeyboardEvent) {
  ...
  if (t.getAttribute("contenteditable") === "true") return false;
  if (t.getAttribute("role") === "combobox" || t.getAttribute("role") === "listbox") return false;
  return true;
}
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      onKeyDown={(e) => {
        ...
        const primary =
          buttons.find((b) => b.dataset.primary === "true") ?? buttons[buttons.length - 1];
        if (primary) {
          e.preventDefault();
          primary.click();
        }
